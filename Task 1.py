...
# на вход функции - для тестируемых функций это статически +28 байт,
# а тестирующую функцию (которая на вход принимает тестируюмую функцию)
# я полагаю и не надо проверять на память.
